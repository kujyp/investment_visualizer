...
def main():
    ...
    # result = filter_remove_not_equals(result, "종목", "삼성전자")
    ...
    # result = filter_remove_not_equals(result, "종목", "한국전력공사")
    # result = filter_remove_not_equals(result, "종목", "엔에이치엔")
    # result = filter_remove_not_equals(result, "종목", "nhn한국사이버결제")
    result = filter_remove_not_equals(result, "종목", "tiger 미국채10년선물")
